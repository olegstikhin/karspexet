...
def send(request):
    if request.method == 'POST':
        ...
        content = "Tack för din anmälan till Kårspexets Finlandsföreställning den 20 februari.\nVänligen betala " + sum + " € till konto FI45 4055 0012 3320 33 (mottagare Peter Leander) med för- och efternamn som meddelande senast " + (datetime.datetime.now() + datetime.timedelta(days=7)).strftime("%d.%m.%Y") + ".\n\nMed vänliga hälsningar,\nKårspexambassaden"
